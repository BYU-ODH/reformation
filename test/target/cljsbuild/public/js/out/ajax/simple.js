...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__50792){
var map__50793 = p__50792;
var map__50793__$1 = ((((!((map__50793 == null)))?((((map__50793.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50793.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50793):map__50793);
var handler = cljs.core.get.call(null,map__50793__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__44515__auto__ = p1__50795_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__50796){
var map__50797 = p__50796;
var map__50797__$1 = ((((!((map__50797 == null)))?((((map__50797.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50797.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50797):map__50797);
var request = map__50797__$1;
var interceptors = cljs.core.get.call(null,map__50797__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__44515__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__44515__auto__)){
return or__44515__auto__;
} else {
