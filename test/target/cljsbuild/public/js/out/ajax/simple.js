...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__46195){
...
var handler = cljs.core.get.call(null,map__46196__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__43261__auto__ = p1__46198_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__46199){
var map__46200 = p__46199;
var map__46200__$1 = ((((!((map__46200 == null)))?((((map__46200.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46200.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46200):map__46200);
var request = map__46200__$1;
var interceptors = cljs.core.get.call(null,map__46200__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__43261__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__43261__auto__)){
return or__43261__auto__;
} else {
