...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__50808_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__50808_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__50809){
var map__50810 = p__50809;
var map__50810__$1 = ((((!((map__50810 == null)))?((((map__50810.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50810.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50810):map__50810);
var handler = cljs.core.get.call(null,map__50810__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__50810__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__50810__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
var h = (function (){var or__44515__auto__ = handler;
...
var e = (function (){var or__44515__auto__ = error_handler;
if(cljs.core.truth_(or__44515__auto__)){
return or__44515__auto__;
} else {
...
return ((function (h,e,map__50810,map__50810__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__50812){
var vec__50813 = p__50812;
var ok = cljs.core.nth.call(null,vec__50813,(0),null);
var result = cljs.core.nth.call(null,vec__50813,(1),null);
...
;})(h,e,map__50810,map__50810__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__50816){
var map__50817 = p__50816;
var map__50817__$1 = ((((!((map__50817 == null)))?((((map__50817.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50817.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50817):map__50817);
var opts = map__50817__$1;
var method = cljs.core.get.call(null,map__50817__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__50817__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__50817__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__50817__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__50817__$1,new cljs.core.Keyword(null,"body","body",-2049205669));

var needs_format = ((body == null)) && (cljs.core.not_EQ_.call(null,method,"GET"));
var rf = (cljs.core.truth_((function (){var or__44515__auto__ = format;
if(cljs.core.truth_(or__44515__auto__)){
return or__44515__auto__;
} else {
return needs_format;
