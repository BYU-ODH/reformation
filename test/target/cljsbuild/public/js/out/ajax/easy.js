...
var G__46209 = format;
var G__46209__$1 = (((G__46209 instanceof cljs.core.Keyword))?G__46209.fqn:null);
switch (G__46209__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__46211_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__46211_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__46212){
...
var handler = cljs.core.get.call(null,map__46213__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__46213__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__46213__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
var h = (function (){var or__43261__auto__ = handler;
...
var e = (function (){var or__43261__auto__ = error_handler;
if(cljs.core.truth_(or__43261__auto__)){
return or__43261__auto__;
} else {
...
return ((function (h,e,map__46213,map__46213__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__46215){
var vec__46216 = p__46215;
var ok = cljs.core.nth.call(null,vec__46216,(0),null);
var result = cljs.core.nth.call(null,vec__46216,(1),null);
...
;})(h,e,map__46213,map__46213__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__46219){
...
var method = cljs.core.get.call(null,map__46220__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__46220__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__46220__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__46220__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__46220__$1,new cljs.core.Keyword(null,"body","body",-2049205669));

var needs_format = ((body == null)) && (cljs.core.not_EQ_.call(null,method,"GET"));
var rf = (cljs.core.truth_((function (){var or__43261__auto__ = format;
if(cljs.core.truth_(or__43261__auto__)){
return or__43261__auto__;
} else {
return needs_format;
